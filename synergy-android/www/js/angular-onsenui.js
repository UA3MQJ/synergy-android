/*! angular-onsenui.js for onsenui - v2.0.0-beta.10-build.2673 - 2016-04-20 */
...
(function () {
  ...
  module.factory('DialogView', function ($onsen) {
    ...
    $onsen.derivePropertiesFromElement(DialogView, ['disabled', 'cancelable', 'visible', 'backButtonHandler']);
  ...
  module.factory('NavigatorView', function ($compile, $onsen) {
    ...
    var NavigatorView = Class.extend({
      ...
      init: function init(scope, element, attrs) {
        ...
        this._clearDerivingMethods = $onsen.deriveMethods(this, element[0], ['insertPage', 'pushPage', 'bringPageTop', 'getDeviceBackButtonHandler', 'popPage', 'replacePage', 'resetToPage', 'canPopPage']);
      },
    ...
    var PageView = Class.extend({
      init: function init(scope, element, attrs) {
        ...
        Object.defineProperty(this, 'backButtonHandler', {
          get: function get() {
            return _this._element[0].backButtonHandler;
          },
  ...
  angular.module('onsen').factory('SplitterSide', function ($onsen, $compile) {
    ...
    var SplitterSide = Class.extend({
      ...
      init: function init(scope, element, attrs) {
        ...
        this._clearDerivingMethods = $onsen.deriveMethods(this, this._element[0], ['isOpen', 'open', 'close', 'toggle']);
